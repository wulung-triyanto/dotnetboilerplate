...
public enum EventStatus
{
    ...
    FAIL = 3,
    REJECTED = 9,
    COMPENSATION_FAILED = 10,
    COMPENSATION_SUCCESS = 11
}
...
public enum GRPCStatus
{
    ...
    /// Note to server developers: if a request is denied for an entire class of users, such as gradual feature rollout or undocumented allowlist, NOT_FOUND may be used.
    ...
    RESOURCE_EXHAUSTED,
    /// <summary>
    /// he operation was rejected because the system is not in a state required for the operation's execution.
